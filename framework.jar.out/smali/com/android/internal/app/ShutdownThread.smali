...
.field private static final MAX_SHUTANIM_WAIT_TIME:I = 0x1388
...
.method static constructor <clinit>()V
    ...
    .line 76
    sput-boolean v1, Lcom/android/internal/app/ShutdownThread;->mIsCharging:Z
...
.method private static beginShutdownSequence(Landroid/content/Context;)V
    ...
    invoke-virtual {v3}, Landroid/os/PowerManager;->isCharging()Z

    move-result v3

    sput-boolean v3, Lcom/android/internal/app/ShutdownThread;->mIsCharging:Z
    ...
    .line 246
    .restart local v1       #mSensorManager:Landroid/hardware/SensorManager;
    :catch_0
    move-exception v0
...
.method public static rebootOrShutdown(ZLjava/lang/String;)V
    ...
    .line 505
    .local v5, tmpActionDoneSync:Ljava/lang/Object;
    if-eqz p0, :cond_2
    ...
    const-string/jumbo v8, "zte.closeshutdown.animation"
    ...
    .line 531
    .local v3, endShutAnimTime:J
    monitor-enter v5

    .line 532
    :goto_1
    :try_start_1
    invoke-static {}, Landroid/os/ShutAnimation;->isShutAnimaFinished()Z
    ...
    const-string/jumbo v9, "the delay time is :"
    ...
    .line 549
    .end local v3           #endShutAnimTime:J
    :cond_1
    const/4 v7, 0x0

    invoke-static {v7}, Landroid/os/Power;->setScreenState(Z)I
    ...
    const-string/jumbo v9, "rebootOrShutdown mIsCharging "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    sget-boolean v9, Lcom/android/internal/app/ShutdownThread;->mIsCharging:Z
    ...
    .line 553
    sget-boolean v7, Lcom/android/internal/app/ShutdownThread;->mIsCharging:Z
    ...
    const-string v8, "Power.shutdown..."
    ...
    .restart local v3       #endShutAnimTime:J
    :cond_3
...
.method public static shutdown(Landroid/content/Context;Z)V
    ...
    invoke-direct {v6, p0}, Lcom/android/internal/app/ShutdownThread$2;-><init>(Landroid/content/Context;)V
...
.method public run()V
    ...
    .line 316
    .local v27, shutmusic:Landroid/content/Intent;
    ...
    const-string/jumbo v3, "zte.closeshutdown.animation"
    ...
    new-instance v3, Lcom/android/internal/app/ShutdownThread$5;

    move-object/from16 v0, p0

    invoke-direct {v3, v0}, Lcom/android/internal/app/ShutdownThread$5;-><init>(Lcom/android/internal/app/ShutdownThread;)V
    ...
    const-string v4, "Waiting for Bluetooth and Radio...radioOff="
    ...
    const-string/jumbo v4, "radioOff && bluetoothOff the delay time is :"
    ...
    .end local v13           #delay:J
    :cond_a
    const-string v2, "cmdProxy.type"

    const-string v3, "audioOff"

    invoke-static {v2, v3}, Landroid/os/SystemProperties;->set(Ljava/lang/String;Ljava/lang/String;)V

    .line 434
    const-string v2, "cmdproxysvc"
    ...
    invoke-virtual {v2}, Landroid/os/PowerManager;->turnOffBacklightBrightness()V
    ...
    .end local v27           #shutmusic:Landroid/content/Intent;
    :cond_c
    const-string v2, "0"
    ...
    .restart local v27       #shutmusic:Landroid/content/Intent;
    :cond_e
    :try_start_8
    move-object/from16 v0, p0
