...
.method constructor <init>(Landroid/content/Context;Landroid/os/Handler;)V
    ...
    invoke-direct {v0, p1}, Landroid/net/Wifi/ZTEWifiCustom;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Landroid/net/wifi/WifiApConfigStore;->mZTEWifiCustom:Landroid/net/Wifi/ZTEWifiCustom;
...
.method private setDefaultApConfiguration()V
    ...
    const-string v6, "djt, setDefaultApConfiguration , config.SSID = "
    ...
    .line 247
    iget-object v4, p0, Landroid/net/wifi/WifiApConfigStore;->mZTEWifiCustom:Landroid/net/Wifi/ZTEWifiCustom;

    invoke-virtual {v4}, Landroid/net/Wifi/ZTEWifiCustom;->isSsidHided()I

    .line 248
    iget-object v4, p0, Landroid/net/wifi/WifiApConfigStore;->mZTEWifiCustom:Landroid/net/Wifi/ZTEWifiCustom;

    invoke-virtual {v4}, Landroid/net/Wifi/ZTEWifiCustom;->getChannelNum()I

    .line 249
    iget-object v4, p0, Landroid/net/wifi/WifiApConfigStore;->mZTEWifiCustom:Landroid/net/Wifi/ZTEWifiCustom;

    invoke-virtual {v4}, Landroid/net/Wifi/ZTEWifiCustom;->getPreamble()I

    .line 250
    iget-object v4, p0, Landroid/net/wifi/WifiApConfigStore;->mZTEWifiCustom:Landroid/net/Wifi/ZTEWifiCustom;

    invoke-virtual {v4}, Landroid/net/Wifi/ZTEWifiCustom;->getMaxClients()I

    .line 251
    iget-object v4, p0, Landroid/net/wifi/WifiApConfigStore;->mZTEWifiCustom:Landroid/net/Wifi/ZTEWifiCustom;

    invoke-virtual {v4}, Landroid/net/Wifi/ZTEWifiCustom;->getMacFilter()Ljava/lang/String;
