...
.method public enter()V
    ...
    invoke-static {v0}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$4708(Landroid/net/wifi/WifiWatchdogStateMachine;)I
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v2}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$4700(Landroid/net/wifi/WifiWatchdogStateMachine;)I
    ...
    invoke-static {v3}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$4800(Landroid/net/wifi/WifiWatchdogStateMachine;)Ljava/util/HashSet;
    ...
    invoke-static {v3}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$4900(Landroid/net/wifi/WifiWatchdogStateMachine;)I
    ...
    .line 1016
    :cond_2
    invoke-static {}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$5000()Z
    ...
    invoke-static {v2, v3}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$5100(Landroid/net/wifi/WifiWatchdogStateMachine;Ljava/lang/String;)V
    ...
    const-string v4, "djt,Disabling current SSID "
    ...
    #getter for: Landroid/net/wifi/WifiWatchdogStateMachine;->mNumCheckFailures:I
    invoke-static {v4}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$4700(Landroid/net/wifi/WifiWatchdogStateMachine;)I
    ...
    #getter for: Landroid/net/wifi/WifiWatchdogStateMachine;->mBssids:Ljava/util/HashSet;
    invoke-static {v4}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$4800(Landroid/net/wifi/WifiWatchdogStateMachine;)Ljava/util/HashSet;
    ...
    invoke-static {v2}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$5300(Landroid/net/wifi/WifiWatchdogStateMachine;)Landroid/net/wifi/WifiManager;
    ...
    invoke-static {v2}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$5400(Landroid/net/wifi/WifiWatchdogStateMachine;)Z
    ...
    #calls: Landroid/net/wifi/WifiWatchdogStateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v2, v3}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$5500(Landroid/net/wifi/WifiWatchdogStateMachine;Lcom/android/internal/util/IState;)V
    ...
    invoke-static {v3}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$5600(Landroid/net/wifi/WifiWatchdogStateMachine;)Landroid/net/wifi/WifiWatchdogStateMachine$BlacklistedApState;
