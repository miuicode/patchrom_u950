...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v11, v8}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$8000(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Ljava/lang/String;)Ljava/lang/String;
    ...
    #calls: Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->getDeviceAddress(Ljava/lang/String;)Ljava/lang/String;
    invoke-static {v9, v8}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$8000(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Ljava/lang/String;)Ljava/lang/String;
    ...
    #calls: Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->setWifiP2pInfoOnGroupFormation(Ljava/lang/String;)V
    invoke-static {v9, v11}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$7900(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Ljava/lang/String;)V
    ...
    invoke-static {v9}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$8100(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)V
    ...
    invoke-static {v9, v11}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$8200(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Lcom/android/internal/util/IState;)V
    ...
    invoke-static {v9, p1}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$8300(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/os/Message;)V
    ...
    #getter for: Landroid/net/wifi/p2p/WifiP2pService;->mPopP2PInvitationBox:Z
    invoke-static {v11}, Landroid/net/wifi/p2p/WifiP2pService;->access$6700(Landroid/net/wifi/p2p/WifiP2pService;)Z
    ...
    #setter for: Landroid/net/wifi/p2p/WifiP2pService;->mPopP2PInvitationBox:Z
    invoke-static {v11, v9}, Landroid/net/wifi/p2p/WifiP2pService;->access$6702(Landroid/net/wifi/p2p/WifiP2pService;Z)Z
    ...
    invoke-static {v11, v9}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$8500(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/net/wifi/p2p/WifiP2pDevice;)V
