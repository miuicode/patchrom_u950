...
.method public setProfile(IIIIIIIIIII)V
    .locals 2
    .parameter "quality"
    .parameter "vCodec"
    .parameter "vBitRate"
    .parameter "vFrameRate"
    .parameter "vFrameWidth"
    .parameter "vFrameHeight"
    .parameter "fileFormat"
    .parameter "aCodec"
    .parameter "aBitRate"
    .parameter "aSampleRate"
    .parameter "aChannels"

    .prologue
    .line 328
    invoke-virtual {p0, p7}, Landroid/media/MediaRecorder;->setOutputFormat(I)V

    .line 329
    invoke-virtual {p0, p4}, Landroid/media/MediaRecorder;->setVideoFrameRate(I)V

    .line 330
    invoke-virtual {p0, p5, p6}, Landroid/media/MediaRecorder;->setVideoSize(II)V

    .line 331
    invoke-virtual {p0, p3}, Landroid/media/MediaRecorder;->setVideoEncodingBitRate(I)V

    .line 332
    invoke-virtual {p0, p2}, Landroid/media/MediaRecorder;->setVideoEncoder(I)V
    ...
    .line 338
    :cond_0
    invoke-virtual {p0, p9}, Landroid/media/MediaRecorder;->setAudioEncodingBitRate(I)V

    .line 339
    invoke-virtual {p0, p11}, Landroid/media/MediaRecorder;->setAudioChannels(I)V

    .line 340
    invoke-virtual {p0, p10}, Landroid/media/MediaRecorder;->setAudioSamplingRate(I)V

    .line 341
    invoke-virtual {p0, p8}, Landroid/media/MediaRecorder;->setAudioEncoder(I)V
