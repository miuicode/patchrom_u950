...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 160
    iput-boolean v6, p0, Landroid/media/AudioService;->mHeadseton:Z
    ...
    invoke-direct {v5, p0, v11}, Landroid/media/AudioService$AudioServiceBroadcastReceiver;-><init>(Landroid/media/AudioService;Landroid/media/AudioService$1;)V
    ...
    invoke-direct {v5, p0, v11}, Landroid/media/AudioService$MediaButtonBroadcastReceiver;-><init>(Landroid/media/AudioService;Landroid/media/AudioService$1;)V
    ...
    .line 333
    iput-object v11, p0, Landroid/media/AudioService;->mSoundPoolLooper:Landroid/os/Looper;
    ...
    .line 3261
    iput-object v11, p0, Landroid/media/AudioService;->mCurrentRcClient:Landroid/media/IRemoteControlClient;
    ...
    .line 3807
    iput v12, p0, Landroid/media/AudioService;->mArtworkExpectedWidth:I

    .line 3808
    iput v12, p0, Landroid/media/AudioService;->mArtworkExpectedHeight:I
    ...
    const-string/jumbo v8, "ro.config.vc_call_vol_steps"
    ...
    const-string/jumbo v8, "zte.is.phone"
    ...
    iput-boolean v5, p0, Landroid/media/AudioService;->mIsPhone:Z
    ...
    const-string v9, "AudioService:mIsPhone is "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget-boolean v9, p0, Landroid/media/AudioService;->mIsPhone:Z
    ...
    .line 369
    iget-boolean v5, p0, Landroid/media/AudioService;->mIsPhone:Z
    ...
    .line 379
    const-string v5, "V985"

    const-string/jumbo v8, "zte.is.phonetype"
    ...
    :goto_1
    iput-boolean v5, p0, Landroid/media/AudioService;->mIsPhoneType:Z
    ...
    const-string v9, "AudioService:mIsPhoneType is "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget-boolean v9, p0, Landroid/media/AudioService;->mIsPhoneType:Z
    ...
    .line 382
    iget-boolean v5, p0, Landroid/media/AudioService;->mIsPhoneType:Z
    ...
    invoke-direct {p0, v5, v6}, Landroid/media/AudioService;->setRingerModeInt(IZ)V
    ...
    .line 405
    iget v5, p0, Landroid/media/AudioService;->mDualmicStatus:I

    if-ne v5, v7, :cond_5

    .line 407
    const-string v5, "dualmic_enabled=true"
    ...
    :cond_3
    new-instance v5, Landroid/view/CustomVolumePanel;

    invoke-direct {v5, p1, p0}, Landroid/view/CustomVolumePanel;-><init>(Landroid/content/Context;Landroid/media/AudioService;)V

    iput-object v5, p0, Landroid/media/AudioService;->mCustomVolumePanel:Landroid/view/CustomVolumePanel;
    ...
    const-string v8, "AudioService sleep error"
    ...
    :cond_5
    const-string v5, "dualmic_enabled=false"
...
.method private checkForRingerModeChange(III)Z
    ...
    const-string v9, "checkForRingerModeChange()uiIndex="
    ...
    const-string v9, "checkForRingerModeChange()direction="
    ...
    const-string v9, "checkForRingerModeChange()vibeInSilent="
    ...
    const-string v7, "checkForRingerModeChange()Normal:newRingerMode="
    ...
    const-string v6, "checkForRingerModeChange()final:newRingerMode="
    ...
    const-string v6, "checkForRingerModeChange()Vibrate:newRingerMode="
    ...
    const-string v6, "checkForRingerModeChange()else:newRingerMode="
...
.method public setStreamVolume(III)V
    ...
    invoke-direct {p0, v7, p1, v8}, Landroid/media/AudioService;->rescaleIndex(III)I
    ...
    .line 695
    .local v0, ACTION_SETFMVOL:Ljava/lang/String;
    new-instance v1, Landroid/content/Intent;
    ...
    .line 699
    .end local v0           #ACTION_SETFMVOL:Ljava/lang/String;
    .end local v1           #intent:Landroid/content/Intent;
    :cond_2
    invoke-direct {p0, p1, v3, p2, p3}, Landroid/media/AudioService;->sendVolumeUpdate(IIII)V
    ...
    .restart local v2       #newRingerMode:I
