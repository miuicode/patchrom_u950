...
.method private SaveRingModeToFile(I)V
    .locals 8
    ...
    const-string v5, "/data/current_mode.txt"
    ...
    const-string v6, "file can write__lyy"
    ...
    invoke-virtual {v3, p1}, Ljava/io/PrintStream;->println(I)V
    ...
    const-string v6, "chmod 777 /data/current_mode.txt"
    ...
    .line 2253
    const-string/jumbo v5, "vDM"

    const-string v6, "MyTreeIoHandler#chmod 777  /data/current_mode.txt failed!"
    ...
    const-string v7, "chmod file error :"
...
.method private persistRingerMode()V
    ...
    invoke-direct {p0, v0}, Landroid/media/AudioService$AudioHandler;->SaveRingModeToFile(I)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static/range {v16 .. v16}, Landroid/media/AudioService$VolumeStreamState;->access$5000(Landroid/media/AudioService$VolumeStreamState;)I
    ...
    invoke-static/range {v16 .. v16}, Landroid/media/AudioService$VolumeStreamState;->access$900(Landroid/media/AudioService$VolumeStreamState;)I
    ...
    .line 2403
    #getter for: Landroid/media/AudioService$VolumeStreamState;->mIndex:I
    invoke-static/range {v16 .. v16}, Landroid/media/AudioService$VolumeStreamState;->access$600(Landroid/media/AudioService$VolumeStreamState;)I
    ...
    invoke-static {v1}, Landroid/media/AudioService;->access$5200(Landroid/media/AudioService;)Landroid/content/Context;
