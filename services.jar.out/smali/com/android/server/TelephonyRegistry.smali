...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/TelephonyRegistry$MyHandler;,
...
.field private static final EVENT_SEND_STICKY_BROADCAST_INTENT:I = 0x1f4
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v2, p0, Lcom/android/server/TelephonyRegistry;->mRemoveList:Ljava/util/ArrayList;
    ...
    iput-object v2, p0, Lcom/android/server/TelephonyRegistry;->mRecords:Ljava/util/ArrayList;

    .line 80
    iput v3, p0, Lcom/android/server/TelephonyRegistry;->mCallState:I
    ...
    .line 88
    iput-boolean v3, p0, Lcom/android/server/TelephonyRegistry;->mMessageWaiting:Z

    .line 90
    iput-boolean v3, p0, Lcom/android/server/TelephonyRegistry;->mCallForwarding:Z

    .line 92
    iput v3, p0, Lcom/android/server/TelephonyRegistry;->mDataActivity:I

    .line 94
    const/4 v2, -0x1

    iput v2, p0, Lcom/android/server/TelephonyRegistry;->mDataConnectionState:I

    .line 96
    iput-boolean v3, p0, Lcom/android/server/TelephonyRegistry;->mDataConnectionPossible:Z
    ...
    iput-object v2, p0, Lcom/android/server/TelephonyRegistry;->mCellLocation:Landroid/os/Bundle;

    .line 116
    const/4 v2, 0x1

    iput v2, p0, Lcom/android/server/TelephonyRegistry;->mOtaspMode:I
    ...
    const-string v2, "TelephonyRegistryThread"
    ...
    .line 138
    new-instance v2, Lcom/android/server/TelephonyRegistry$MyHandler;

    invoke-virtual {v0}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v3

    invoke-direct {v2, p0, v3}, Lcom/android/server/TelephonyRegistry$MyHandler;-><init>(Lcom/android/server/TelephonyRegistry;Landroid/os/Looper;)V

    iput-object v2, p0, Lcom/android/server/TelephonyRegistry;->mHandler:Landroid/os/Handler;
    ...
    iput-object v2, p0, Lcom/android/server/TelephonyRegistry;->mBatteryStats:Lcom/android/internal/app/IBatteryStats;
    ...
    iput-object v2, p0, Lcom/android/server/TelephonyRegistry;->mConnectedApns:Ljava/util/ArrayList;

    .line 149
    return-void
.end method

.method static synthetic access$000(Lcom/android/server/TelephonyRegistry;)Landroid/content/Context;
    .locals 1
    .parameter "x0"
...
.method private broadcastDataConnectionFailed(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v2, " broadcastDataConnectionFailed enter "
    ...
    .line 670
    iget-object v1, p0, Lcom/android/server/TelephonyRegistry;->mHandler:Landroid/os/Handler;

    iget-object v2, p0, Lcom/android/server/TelephonyRegistry;->mHandler:Landroid/os/Handler;
