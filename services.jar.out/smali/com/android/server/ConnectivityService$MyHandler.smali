...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v16, " djt, EVENT_CONFIGURATION_CHANGED msg, call handleConnectivityChange"
    ...
    #calls: Lcom/android/server/ConnectivityService;->handleConnectivityChange(IZI)V
    invoke-static/range {v15 .. v18}, Lcom/android/server/ConnectivityService;->access$1000(Lcom/android/server/ConnectivityService;IZI)V
    ...
    invoke-static/range {v15 .. v17}, Lcom/android/server/ConnectivityService;->access$1100(Lcom/android/server/ConnectivityService;IZ)V
    ...
    #getter for: Lcom/android/server/ConnectivityService;->disconnectNetType:I
    ...
    #getter for: Lcom/android/server/ConnectivityService;->wlanInterfaceName:Ljava/lang/String;
    ...
    const-string v16, "[handleConnectivityChange] add WLAN DefaultRoute"
    ...
    invoke-static/range {v15 .. v16}, Lcom/android/server/ConnectivityService;->access$2202(Lcom/android/server/ConnectivityService;I)I
    ...
    invoke-static/range {v16 .. v16}, Lcom/android/server/ConnectivityService;->access$2300(Lcom/android/server/ConnectivityService;)[Landroid/net/NetworkStateTracker;
    ...
    #calls: Lcom/android/server/ConnectivityService;->addDefaultRoute(Landroid/net/NetworkStateTracker;)V
    invoke-static/range {v15 .. v16}, Lcom/android/server/ConnectivityService;->access$2400(Lcom/android/server/ConnectivityService;Landroid/net/NetworkStateTracker;)V
    ...
    #setter for: Lcom/android/server/ConnectivityService;->wlanInterfaceName:Ljava/lang/String;
    invoke-static/range {v15 .. v16}, Lcom/android/server/ConnectivityService;->access$2102(Lcom/android/server/ConnectivityService;Ljava/lang/String;)Ljava/lang/String;
    ...
    #getter for: Lcom/android/server/ConnectivityService;->mobileInterfaceName:Ljava/lang/String;
    invoke-static {v15}, Lcom/android/server/ConnectivityService;->access$2500(Lcom/android/server/ConnectivityService;)Ljava/lang/String;
    ...
    const-string v16, "[handleConnectivityChange] add MOBILE DefaultRoute"
    ...
    #setter for: Lcom/android/server/ConnectivityService;->mobileInterfaceName:Ljava/lang/String;
    invoke-static/range {v15 .. v16}, Lcom/android/server/ConnectivityService;->access$2502(Lcom/android/server/ConnectivityService;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v16, "[setWlanPrefer] removeTYPE_MOBILE DefaultRoute "
    ...
    invoke-virtual/range {v15 .. v16}, Lcom/android/server/ConnectivityService;->removeDefaultRoute(Landroid/net/NetworkStateTracker;)V
    ...
    const-string v16, "[setMobilePrefer] remove TYPE_WIFI DefaultRoute "
    ...
    invoke-static {v15}, Lcom/android/server/ConnectivityService;->access$2200(Lcom/android/server/ConnectivityService;)I
    ...
    #getter for: Lcom/android/server/ConnectivityService;->mActiveDefaultNetwork:I
    invoke-static/range {v16 .. v16}, Lcom/android/server/ConnectivityService;->access$2200(Lcom/android/server/ConnectivityService;)I

    move-result v16

    const/16 v17, 0x1

    #calls: Lcom/android/server/ConnectivityService;->handleDnsConfigurationChange(II)V
    invoke-static/range {v15 .. v17}, Lcom/android/server/ConnectivityService;->access$2700(Lcom/android/server/ConnectivityService;II)V
