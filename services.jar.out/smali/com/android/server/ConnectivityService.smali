...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/ConnectivityService$WlanSettingsChangeObserver;,
...
.field private static final EVENT_ADD_DEFAULT_ROUTE:I = 0x74
...
.field private static final EVENT_REMOVE_MOBLIE_DEFAULT_ROUTE:I = 0x76

.field private static final EVENT_REMOVE_WIFI_DEFAULT_ROUTE:I = 0x75
...
.field private static isWlanAnd3GValid:Z
...
# instance fields
.field private disconnectNetType:I
...
.field private mCurrWlanPrefered:I
...
.field private mWlanObserver:Lcom/android/server/ConnectivityService$WlanSettingsChangeObserver;

.field private mobileInterfaceName:Ljava/lang/String;

.field private moblieGateWayAddr:I

.field private twService:Lcom/android/server/TwService;

.field private wlanGateWayAddr:I

.field private wlanInterfaceName:Ljava/lang/String;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/ConnectivityService;->CONTENT_URI:Landroid/net/Uri;

    .line 347
    const/4 v0, 0x1

    sput-boolean v0, Lcom/android/server/ConnectivityService;->isWlanAnd3GValid:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;Landroid/net/INetworkStatsService;Landroid/net/INetworkPolicyManager;)V
    ...
    iput v2, v0, Lcom/android/server/ConnectivityService;->mCurrWlanPrefered:I
    ...
    iget-object v2, v0, Lcom/android/server/ConnectivityService;->mTwSatetracker:Landroid/net/wifi/TwStateTracker;

    if-nez v2, :cond_15

    .line 533
    new-instance v2, Landroid/net/wifi/TwStateTracker;

    move-object/from16 v0, p1

    invoke-direct {v2, v0}, Landroid/net/wifi/TwStateTracker;-><init>(Landroid/content/Context;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/ConnectivityService;->mTwSatetracker:Landroid/net/wifi/TwStateTracker;

    .line 535
    :cond_15
    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/android/server/ConnectivityService;->twService:Lcom/android/server/TwService;

    if-nez v2, :cond_16

    .line 536
    new-instance v2, Lcom/android/server/TwService;

    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/android/server/ConnectivityService;->mTwSatetracker:Landroid/net/wifi/TwStateTracker;

    move-object/from16 v0, p1

    invoke-direct {v2, v0, v3}, Lcom/android/server/TwService;-><init>(Landroid/content/Context;Landroid/net/wifi/TwStateTracker;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/ConnectivityService;->twService:Lcom/android/server/TwService;

    .line 538
    :cond_16
    const-string v2, "tw_wifi"

    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/android/server/ConnectivityService;->twService:Lcom/android/server/TwService;
    ...
    const-string v3, "tw_wifi service can not be registered!\n"

    invoke-static {v2, v3}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    .line 544
    :cond_17
    new-instance v2, Lcom/android/server/TwWifiPolicy;

    move-object/from16 v0, p1

    invoke-direct {v2, v0}, Lcom/android/server/TwWifiPolicy;-><init>(Landroid/content/Context;)V
    ...
    .line 612
    new-instance v2, Lcom/android/server/ConnectivityService$WlanSettingsChangeObserver;

    move-object/from16 v0, p0

    invoke-direct {v2, v0}, Lcom/android/server/ConnectivityService$WlanSettingsChangeObserver;-><init>(Lcom/android/server/ConnectivityService;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/ConnectivityService;->mWlanObserver:Lcom/android/server/ConnectivityService$WlanSettingsChangeObserver;
    ...
    sget-object v3, Lcom/android/server/ConnectivityService;->CONTENT_URI:Landroid/net/Uri;

    const/4 v5, 0x1

    move-object/from16 v0, p0

    iget-object v6, v0, Lcom/android/server/ConnectivityService;->mWlanObserver:Lcom/android/server/ConnectivityService$WlanSettingsChangeObserver;

    invoke-virtual {v2, v3, v5, v6}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;)V

    .line 616
    invoke-direct/range {p0 .. p0}, Lcom/android/server/ConnectivityService;->getWlanPreferValue()I
...
.method static synthetic access$1000(Lcom/android/server/ConnectivityService;IZI)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
    ...
    .prologue
    .line 124
    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/ConnectivityService;->handleConnectivityChange(IZI)V

    return-void
.end method

.method static synthetic access$1100(Lcom/android/server/ConnectivityService;IZ)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$2000(Lcom/android/server/ConnectivityService;)I
    ...
    .prologue
    .line 124
    iget v0, p0, Lcom/android/server/ConnectivityService;->disconnectNetType:I
...
.method static synthetic access$2100(Lcom/android/server/ConnectivityService;)Ljava/lang/String;
    ...
    .prologue
    .line 124
    iget-object v0, p0, Lcom/android/server/ConnectivityService;->wlanInterfaceName:Ljava/lang/String;

    return-object v0
.end method

.method static synthetic access$2102(Lcom/android/server/ConnectivityService;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 124
    iput-object p1, p0, Lcom/android/server/ConnectivityService;->wlanInterfaceName:Ljava/lang/String;
...
.method static synthetic access$2202(Lcom/android/server/ConnectivityService;I)I
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$2300(Lcom/android/server/ConnectivityService;)[Landroid/net/NetworkStateTracker;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$2400(Lcom/android/server/ConnectivityService;Landroid/net/NetworkStateTracker;)V
    ...
    .prologue
    .line 124
    invoke-direct {p0, p1}, Lcom/android/server/ConnectivityService;->addDefaultRoute(Landroid/net/NetworkStateTracker;)V
...
.method static synthetic access$2500(Lcom/android/server/ConnectivityService;)Ljava/lang/String;
    ...
    .prologue
    .line 124
    iget-object v0, p0, Lcom/android/server/ConnectivityService;->mobileInterfaceName:Ljava/lang/String;

    return-object v0
.end method

.method static synthetic access$2502(Lcom/android/server/ConnectivityService;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 124
    iput-object p1, p0, Lcom/android/server/ConnectivityService;->mobileInterfaceName:Ljava/lang/String;
...
.method static synthetic access$2700(Lcom/android/server/ConnectivityService;II)V
    ...
    .prologue
    .line 124
    invoke-direct {p0, p1, p2}, Lcom/android/server/ConnectivityService;->handleDnsConfigurationChange(II)V
...
.method static synthetic access$3100(Lcom/android/server/ConnectivityService;)Landroid/os/Handler;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$3200(Lcom/android/server/ConnectivityService;)V
    ...
    .prologue
    .line 124
    invoke-direct {p0}, Lcom/android/server/ConnectivityService;->onWlanPrefered()V
...
.method static synthetic access$3400(Lcom/android/server/ConnectivityService;Ljava/lang/String;Ljava/lang/String;Ljava/util/Collection;Ljava/lang/String;)Z
    .locals 1
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method private addDefaultRoute(Landroid/net/NetworkStateTracker;)V
    ...
    const-string v7, "djt,addDefaultRoute: "
    ...
    const-string v7, "djt,addDefaultRoute for "
...
.method private addMobileDns(I)V
    .locals 10
    .parameter "dnsNum"
    ...
    invoke-virtual {p0, v6}, Lcom/android/server/ConnectivityService;->getMobileNameServers(Landroid/net/NetworkStateTracker;)[Ljava/lang/String;

    move-result-object v5

    .line 3679
    .local v5, mobilednsList:[Ljava/lang/String;
    if-nez v5, :cond_0
    ...
    .line 3684
    .local v4, mobiledns:Ljava/lang/String;
    if-eqz v4, :cond_2
    ...
    const-string v8, "adding mobiledns "
    ...
    .end local p1
    .restart local v1       #dnsNum:I
    goto :goto_1

    .end local v4           #mobiledns:Ljava/lang/String;
    :cond_1
    move p1, v1
    ...
    .end local p1
    .restart local v1       #dnsNum:I
    .restart local v4       #mobiledns:Ljava/lang/String;
    :cond_2
    move p1, v1
...
.method private addPDPDefaultRoute(Ljava/lang/String;)I
    .locals 5
    .parameter "ifname"
    ...
    const-string v4, "djt, addPDPDefaultRoute, param = "
    ...
    const-string v3, "addPDPRoute"

    invoke-static {v2, v3}, Landroid/os/SystemProperties;->set(Ljava/lang/String;Ljava/lang/String;)V

    .line 2005
    const-string v2, "cmdProxy.param"
...
.method private addWlanDns(I)V
    ...
    invoke-virtual {p0, v6}, Lcom/android/server/ConnectivityService;->getWifiNameServers(Landroid/net/NetworkStateTracker;)[Ljava/lang/String;

    move-result-object v5

    .line 3698
    .local v5, wlandnsList:[Ljava/lang/String;
    if-nez v5, :cond_0
    ...
    .line 3703
    .local v4, wlandns:Ljava/lang/String;
    if-eqz v4, :cond_2
    ...
    const-string v8, "adding wlandns "
    ...
    .end local v4           #wlandns:Ljava/lang/String;
    :cond_1
    move p1, v1
    ...
    .end local p1
    .restart local v1       #dnsNum:I
    .restart local v4       #wlandns:Ljava/lang/String;
    :cond_2
    move p1, v1
...
.method private getWlanPreferValue()I
    .locals 5
    ...
    .local v1, prefer:I
    :try_start_0
    const-string v3, "wifi_prefer_value"
    ...
    const-string v4, "wifi_prefer_value"
    ...
    const-string v4, "djt,wlan-prefer value is "
...
.method private handleConnect(Landroid/net/NetworkInfo;)V
    ...
    const-string v6, "djt, call handleConnectivityChange in handleConnect"
    ...
    .line 1981
    invoke-direct {p0, v4, v10, v11}, Lcom/android/server/ConnectivityService;->handleConnectivityChange(IZI)V
...
.method private handleConnectivityChange(IZI)V
    .locals 18
    .parameter "netType"
    .parameter "doReset"
    .parameter "operatorNum"
    ...
    const-string v17, "djt, handleConnectivityChange enter, netType = "
    ...
    invoke-direct {v0, v1, v15}, Lcom/android/server/ConnectivityService;->handleDnsConfigurationChange(II)V
    ...
    const-string v17, "djt, handleConnectivityChange,mNetTrackers["
    ...
    const-string v16, "handleConnectivityChange: changed linkProperty["
    ...
    .line 2151
    invoke-virtual {v4, v11}, Landroid/net/LinkProperties;->isIdenticalInterfaceName(Landroid/net/LinkProperties;)Z
    ...
    .line 2152
    invoke-virtual {v4, v11}, Landroid/net/LinkProperties;->compareAddresses(Landroid/net/LinkProperties;)Landroid/net/LinkProperties$CompareResult;
    ...
    iget-object v15, v3, Landroid/net/LinkProperties$CompareResult;->removed:Ljava/util/Collection;
    ...
    iget-object v15, v3, Landroid/net/LinkProperties$CompareResult;->added:Ljava/util/Collection;
    ...
    .restart local v11       #newLp:Landroid/net/LinkProperties;
    .restart local v13       #resetMask:I
    :cond_4
    new-instance v15, Ljava/lang/StringBuilder;
    ...
    const-string v17, "djt, handleConnectivityChange,mNetConfigs["
    ...
    const-string v16, "djt, handleConnectivityChange,wifi connected"

    invoke-static/range {v15 .. v16}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 2220
    invoke-direct/range {p0 .. p0}, Lcom/android/server/ConnectivityService;->setWlanPrefer()V
    ...
    invoke-direct {v0, v11, v4, v15}, Lcom/android/server/ConnectivityService;->updateRoutes(Landroid/net/LinkProperties;Landroid/net/LinkProperties;Z)Z
    ...
    .line 2336
    invoke-static {v7, v13}, Landroid/net/NetworkUtils;->resetConnections(Ljava/lang/String;I)I
    ...
    invoke-virtual {v15, v7, v0}, Lcom/android/server/connectivity/Vpn;->interfaceStatusChanged(Ljava/lang/String;Z)V
    ...
    const-string v16, "resetting DNS cache for "
    ...
    invoke-interface {v15, v7}, Landroid/os/INetworkManagementService;->flushInterfaceDnsCache(Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 2197
    :cond_10
    invoke-virtual {v11}, Landroid/net/LinkProperties;->getHttpProxy()Landroid/net/ProxyProperties;
    ...
    const-string v16, "djt, handleConnectivityChange, wifi is not connected"
    ...
    const-string v16, "djt, handleConnectivityChange, mobile is connected"
    ...
    .line 2239
    invoke-direct/range {p0 .. p0}, Lcom/android/server/ConnectivityService;->setMobilePrefer()V
    ...
    const-string v16, "djt, handleConnectivityChange, mobile is not connected"
    ...
    const-string v17, "] is not Default, add private dns route"
    ...
    invoke-direct {v0, v15}, Lcom/android/server/ConnectivityService;->addPrivateDnsRoutes(Landroid/net/NetworkStateTracker;)V
    ...
    iput v15, v0, Lcom/android/server/ConnectivityService;->mActiveDefaultNetwork:I
    ...
    invoke-direct {v0, v15}, Lcom/android/server/ConnectivityService;->addDefaultRoute(Landroid/net/NetworkStateTracker;)V
    ...
    const-string v17, "djt, handleConnectivityChange,remove mNetTrackers["
    ...
    invoke-direct {v0, v15}, Lcom/android/server/ConnectivityService;->removePrivateDnsRoutes(Landroid/net/NetworkStateTracker;)V
    ...
    .line 2286
    .local v10, mobileIfname:Ljava/lang/String;
    const-string v15, "ConnectivityService"
    ...
    invoke-direct {v0, v10}, Lcom/android/server/ConnectivityService;->addPDPDefaultRoute(Ljava/lang/String;)I
    ...
    iput-object v15, v0, Lcom/android/server/ConnectivityService;->mobileInterfaceName:Ljava/lang/String;
...
.method private handleDisconnect(Landroid/net/NetworkInfo;)V
    ...
    const-string v20, "djt, call handleConnectivityChange in handleDisconnect"
    ...
    invoke-direct {v0, v1, v4, v2}, Lcom/android/server/ConnectivityService;->handleConnectivityChange(IZI)V
    ...
    const-string v21, "zhaoch mNetTrackers[mActiveDefaultNetwork].getNetworkInfo().getType() "
...
.method private handleDnsConfigurationChange(II)V
    .locals 30
    .parameter "netType"
    .parameter "operatorNum"
    ...
    const-string v27, "djt enter handleDnsConfigurationChange"
    ...
    aget-object v18, v26, p1

    .line 2778
    .local v18, nt:Landroid/net/NetworkStateTracker;
    if-eqz v18, :cond_a
    ...
    invoke-interface/range {v18 .. v18}, Landroid/net/NetworkStateTracker;->isTeardownRequested()Z
    ...
    .line 2781
    .local v19, p:Landroid/net/LinkProperties;
    if-nez v19, :cond_0

    .line 2927
    .end local v19           #p:Landroid/net/LinkProperties;
    :goto_0
    return-void

    .line 2782
    .restart local v19       #p:Landroid/net/LinkProperties;
    :cond_0
    invoke-virtual/range {v19 .. v19}, Landroid/net/LinkProperties;->getDnses()Ljava/util/Collection;
    ...
    invoke-virtual/range {v26 .. v26}, Landroid/net/NetworkInfo;->getExtraInfo()Ljava/lang/String;

    move-result-object v5

    .line 2790
    .local v5, apnstr:Ljava/lang/String;
    const-string v26, "cmwap"
    ...
    .line 2795
    .local v22, tmpdnses:Ljava/util/Collection;,"Ljava/util/Collection<Ljava/net/InetAddress;>;"
    const-string v26, "ConnectivityService"

    const-string v27, "zhaoch,default cmwap"
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lcom/android/server/ConnectivityService;->updateDns(Ljava/lang/String;Ljava/lang/String;Ljava/util/Collection;Ljava/lang/String;)Z
    ...
    .end local v22           #tmpdnses:Ljava/util/Collection;,"Ljava/util/Collection<Ljava/net/InetAddress;>;"
    :goto_1
    move-object/from16 v0, p0
    ...
    const-string v28, "djt, mNumDnsEntries ="
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/ConnectivityService;->getMobileNameServers(Landroid/net/NetworkStateTracker;)[Ljava/lang/String;

    move-result-object v16

    .line 2834
    .local v16, mobilednsList:[Ljava/lang/String;
    if-nez v16, :cond_7

    .line 2836
    const-string v26, "ConnectivityService"

    const-string v27, "djt, got null mobilednsList[] !! , handleDnsConfigurationChange exit"
    ...
    .line 2802
    .end local v11           #j:I
    .end local v16           #mobilednsList:[Ljava/lang/String;
    .restart local v5       #apnstr:Ljava/lang/String;
    .restart local v22       #tmpdnses:Ljava/util/Collection;,"Ljava/util/Collection<Ljava/net/InetAddress;>;"
    :catchall_0
    move-exception v26
    ...
    invoke-direct {v0, v1, v2, v8, v3}, Lcom/android/server/ConnectivityService;->updateDns(Ljava/lang/String;Ljava/lang/String;Ljava/util/Collection;Ljava/lang/String;)Z
    ...
    .restart local v16       #mobilednsList:[Ljava/lang/String;
    :cond_7
    ...
    .line 2842
    .local v15, mobiledns:Ljava/lang/String;
    if-eqz v15, :cond_15

    const-string v26, "0.0.0.0"
    ...
    const-string v28, "djt,adding mobile dns"
    ...
    invoke-interface/range {v28 .. v28}, Landroid/net/NetworkStateTracker;->getNetworkInfo()Landroid/net/NetworkInfo;

    move-result-object v28

    invoke-virtual/range {v28 .. v28}, Landroid/net/NetworkInfo;->getTypeName()Ljava/lang/String;
    ...
    .end local v15           #mobiledns:Ljava/lang/String;
    :cond_8
    move v11, v12
    ...
    iput v11, v0, Lcom/android/server/ConnectivityService;->mNumDnsEntries:I
    ...
    const-string v28, "djt,remove net.dns"
    ...
    .line 2854
    .end local v13           #k:I
    .restart local v8       #dnses:Ljava/util/Collection;,"Ljava/util/Collection<Ljava/net/InetAddress;>;"
    .restart local v11       #j:I
    .restart local v17       #network:Ljava/lang/String;
    .restart local v19       #p:Landroid/net/LinkProperties;
    :cond_b
    if-nez p1, :cond_9
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/ConnectivityService;->getWifiNameServers(Landroid/net/NetworkStateTracker;)[Ljava/lang/String;

    move-result-object v24

    .line 2859
    .local v24, wlandnsList:[Ljava/lang/String;
    if-nez v24, :cond_c

    .line 2861
    const-string v26, "ConnectivityService"

    const-string v27, "djt,got null wlandnsList [] !!, handleDnsConfigurationChange exit "
    ...
    .line 2867
    .local v23, wlandns:Ljava/lang/String;
    if-eqz v23, :cond_13
    ...
    const-string v28, "djt,adding wlandns "
    ...
    .end local v14           #len$:I
    .end local v17           #network:Ljava/lang/String;
    .end local v23           #wlandns:Ljava/lang/String;
    .end local v24           #wlandnsList:[Ljava/lang/String;
    :cond_d
    :try_start_4
    move-object/from16 v0, p0
    ...
    invoke-interface/range {v26 .. v28}, Landroid/os/INetworkManagementService;->setDnsServersForInterface(Ljava/lang/String;[Ljava/lang/String;)V
    :try_end_4
    ...
    aget-object v21, v26, p1

    .line 2892
    .local v21, pids:Ljava/util/List;
    const/16 v25, 0x0
    ...
    .line 2894
    .local v20, pid:Ljava/lang/Integer;
    ...
    invoke-direct {v0, v8, v1}, Lcom/android/server/ConnectivityService;->writePidDns(Ljava/util/Collection;I)Z
    ...
    .line 2887
    .end local v20           #pid:Ljava/lang/Integer;
    .end local v21           #pids:Ljava/util/List;
    .end local v25           #y:I
    :catch_0
    move-exception v9
    ...
    const-string v27, "exception setting dns servers: "
    ...
    const-string v27, "djt, add mobile dns"
    ...
    invoke-direct {v0, v1}, Lcom/android/server/ConnectivityService;->addMobileDns(I)V
    ...
    const-string v27, "djt exit handleDnsConfigurationChange"
    ...
    const-string v27, "djt, add wlan dns"
    ...
    invoke-direct {v0, v1}, Lcom/android/server/ConnectivityService;->addWlanDns(I)V
    ...
    .restart local v17       #network:Ljava/lang/String;
    .restart local v19       #p:Landroid/net/LinkProperties;
    .restart local v23       #wlandns:Ljava/lang/String;
    .restart local v24       #wlandnsList:[Ljava/lang/String;
    :cond_13
    move v11, v12
    ...
    .end local v24           #wlandnsList:[Ljava/lang/String;
    .restart local v12       #j:I
    .restart local v15       #mobiledns:Ljava/lang/String;
    .restart local v16       #mobilednsList:[Ljava/lang/String;
    :cond_15
    move v11, v12
...
.method private onWlanPreferChangeMobile()V
    .locals 7
    ...
    const-string v3, "[onWlanPreferChangeMobile]"
    ...
    .line 3639
    .local v1, ws:Landroid/net/NetworkStateTracker;
    invoke-interface {v1}, Landroid/net/NetworkStateTracker;->getNetworkInfo()Landroid/net/NetworkInfo;
    ...
    .line 3654
    .end local v0           #p:Landroid/net/LinkProperties;
    :goto_0
    return-void

    .line 3643
    .restart local v0       #p:Landroid/net/LinkProperties;
    :cond_0
    invoke-virtual {v0}, Landroid/net/LinkProperties;->getInterfaceName()Ljava/lang/String;

    move-result-object v2

    iput-object v2, p0, Lcom/android/server/ConnectivityService;->wlanInterfaceName:Ljava/lang/String;
    ...
    const-string v4, "djt,onWlanPreferChangeMobile,wlanInterfaceName = "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget-object v4, p0, Lcom/android/server/ConnectivityService;->wlanInterfaceName:Ljava/lang/String;
    ...
    .end local v0           #p:Landroid/net/LinkProperties;
    :goto_1
    iget-object v2, p0, Lcom/android/server/ConnectivityService;->wlanInterfaceName:Ljava/lang/String;
    ...
    invoke-virtual {p0, v2}, Lcom/android/server/ConnectivityService;->removeDefaultRoute(Landroid/net/NetworkStateTracker;)V
    ...
    invoke-direct {p0, v2}, Lcom/android/server/ConnectivityService;->addDefaultRoute(Landroid/net/NetworkStateTracker;)V

    .line 3653
    :cond_1
    invoke-direct {p0, v6, v5}, Lcom/android/server/ConnectivityService;->handleDnsConfigurationChange(II)V
...
.method private onWlanPreferChangeWlan()V
    .locals 7
    ...
    .line 3658
    .local v1, ws:Landroid/net/MobileDataStateTracker;
    ...
    .line 3660
    invoke-virtual {v1}, Landroid/net/MobileDataStateTracker;->getLinkProperties()Landroid/net/LinkProperties;
    ...
    iput-object v2, p0, Lcom/android/server/ConnectivityService;->mobileInterfaceName:Ljava/lang/String;
    ...
    const-string v4, "mobileInterfaceName = "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget-object v4, p0, Lcom/android/server/ConnectivityService;->mobileInterfaceName:Ljava/lang/String;
    ...
    .end local v0           #p:Landroid/net/LinkProperties;
    :goto_1
    iget-object v2, p0, Lcom/android/server/ConnectivityService;->mobileInterfaceName:Ljava/lang/String;
    ...
    .line 3672
    :cond_1
    invoke-direct {p0, v5, v5}, Lcom/android/server/ConnectivityService;->handleDnsConfigurationChange(II)V
...
.method private onWlanPrefered()V
    .locals 5
    ...
    const-string v2, "djt,onWlanPrefered enter"

    invoke-static {v1, v2}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 3714
    invoke-direct {p0}, Lcom/android/server/ConnectivityService;->getWlanPreferValue()I

    move-result v0

    .line 3715
    .local v0, preferValue:I
    const-string v1, "ConnectivityService"
    ...
    const-string v3, "djt,onWlanPrefered ,currentvalue = "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget v3, p0, Lcom/android/server/ConnectivityService;->mCurrWlanPrefered:I

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v2

    const-string v3, ",prefer value= "
    ...
    .line 3716
    iget v1, p0, Lcom/android/server/ConnectivityService;->mCurrWlanPrefered:I
    ...
    const-string v3, "onWlanPrefered value changed: "
    ...
    .line 3718
    iput v0, p0, Lcom/android/server/ConnectivityService;->mCurrWlanPrefered:I
    ...
    const-string v2, "wlan is not connected "
    ...
    .line 3725
    :cond_1
    invoke-direct {p0}, Lcom/android/server/ConnectivityService;->onWlanPreferChangeWlan()V
    ...
    const-string v2, "mobile is not connected "
    ...
    .line 3731
    :cond_3
    invoke-direct {p0}, Lcom/android/server/ConnectivityService;->onWlanPreferChangeMobile()V
...
.method private sendStickyBroadcast(Landroid/content/Intent;)V
    ...
    .line 1860
    :try_start_0
    iget-boolean v1, p0, Lcom/android/server/ConnectivityService;->mSystemReady:Z
    ...
    const-string v2, "sendStickyBroadcast: action="
    ...
    const-string v2, "sendStickyBroadcast info = "
...
.method private setMobilePrefer()V
    .locals 10
    ...
    const-string v6, "djt,enter setMobilePrefer"
    ...
    .line 3593
    .local v0, mMobileStatetracker:Landroid/net/MobileDataStateTracker;
    iget-object v5, p0, Lcom/android/server/ConnectivityService;->mNetTrackers:[Landroid/net/NetworkStateTracker;

    aget-object v1, v5, v9

    check-cast v1, Landroid/net/wifi/WifiStateTracker;

    .line 3594
    .local v1, mWifiStateTracker:Landroid/net/wifi/WifiStateTracker;
    invoke-virtual {v1}, Landroid/net/wifi/WifiStateTracker;->getNetworkInfo()Landroid/net/NetworkInfo;
    ...
    .line 3596
    invoke-virtual {v1}, Landroid/net/wifi/WifiStateTracker;->getLinkProperties()Landroid/net/LinkProperties;

    move-result-object v4

    .line 3597
    .local v4, wifiLink:Landroid/net/LinkProperties;
    if-nez v4, :cond_1

    .line 3633
    .end local v4           #wifiLink:Landroid/net/LinkProperties;
    :cond_0
    :goto_0
    return-void

    .line 3599
    .restart local v4       #wifiLink:Landroid/net/LinkProperties;
    :cond_1
    invoke-virtual {v4}, Landroid/net/LinkProperties;->getInterfaceName()Ljava/lang/String;

    move-result-object v5

    iput-object v5, p0, Lcom/android/server/ConnectivityService;->wlanInterfaceName:Ljava/lang/String;
    ...
    const-string v7, "djt,wlanInterfaceName = "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget-object v7, p0, Lcom/android/server/ConnectivityService;->wlanInterfaceName:Ljava/lang/String;
    ...
    .end local v4           #wifiLink:Landroid/net/LinkProperties;
    :cond_2
    invoke-virtual {v0}, Landroid/net/MobileDataStateTracker;->getLinkProperties()Landroid/net/LinkProperties;

    move-result-object v3

    .line 3603
    .local v3, mobileLink:Landroid/net/LinkProperties;
    if-eqz v3, :cond_0
    ...
    .line 3607
    .local v2, mobileInterfaceName:Ljava/lang/String;
    const-string v5, "ConnectivityService"
    ...
    const-string v7, "djt, setMobilePrefer interfaceName = "
    ...
    .line 3609
    invoke-direct {p0, v8, v9}, Lcom/android/server/ConnectivityService;->handleDnsConfigurationChange(II)V

    .line 3611
    const-string v5, "ConnectivityService"

    const-string v6, "djt,setMobilePrefer remove wlan default route and add mobile default route "
    ...
    invoke-virtual {p0, v5}, Lcom/android/server/ConnectivityService;->removeDefaultRoute(Landroid/net/NetworkStateTracker;)V
    ...
    invoke-direct {p0, v5}, Lcom/android/server/ConnectivityService;->addDefaultRoute(Landroid/net/NetworkStateTracker;)V

    goto :goto_0
.end method

.method private setWlanPrefer()V
    .locals 10
    ...
    const-string v6, "djt,enter setWlanPrefer1"
    ...
    .line 3545
    .local v2, mWifiStateTracker:Landroid/net/wifi/WifiStateTracker;
    iget-object v5, p0, Lcom/android/server/ConnectivityService;->mNetTrackers:[Landroid/net/NetworkStateTracker;
    ...
    .line 3546
    .local v0, mMobileStatetracker:Landroid/net/MobileDataStateTracker;
    invoke-virtual {v0}, Landroid/net/MobileDataStateTracker;->getNetworkInfo()Landroid/net/NetworkInfo;
    ...
    .line 3588
    .end local v3           #mobileLink:Landroid/net/LinkProperties;
    :cond_0
    :goto_0
    return-void

    .line 3551
    .restart local v3       #mobileLink:Landroid/net/LinkProperties;
    :cond_1
    invoke-virtual {v3}, Landroid/net/LinkProperties;->getInterfaceName()Ljava/lang/String;

    move-result-object v5

    iput-object v5, p0, Lcom/android/server/ConnectivityService;->mobileInterfaceName:Ljava/lang/String;
    ...
    const-string v7, "djt,mobileInterfaceName = "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget-object v7, p0, Lcom/android/server/ConnectivityService;->mobileInterfaceName:Ljava/lang/String;
    ...
    .end local v3           #mobileLink:Landroid/net/LinkProperties;
    :cond_2
    invoke-virtual {v2}, Landroid/net/wifi/WifiStateTracker;->getLinkProperties()Landroid/net/LinkProperties;
    ...
    .line 3560
    .local v1, mWifiInterfaceName:Ljava/lang/String;
    const-string v5, "ConnectivityService"
    ...
    const-string v7, "djt,WlanPrefer wifiInterfaceName ="
    ...
    .line 3562
    invoke-direct {p0, v8, v8}, Lcom/android/server/ConnectivityService;->handleDnsConfigurationChange(II)V

    .line 3564
    const-string v5, "ConnectivityService"

    const-string v6, "djt,setWlanPrefer remove mobile default route and add wlan default route "
...
.method public getActiveNetworkInfo()Landroid/net/NetworkInfo;
    ...
    const-string v4, "djt, getActiveNetworkInfo, netType = "
...
.method public getMobileNameServers(Landroid/net/NetworkStateTracker;)[Ljava/lang/String;
    .locals 10
    .parameter "nt"
    ...
    const-string v5, "net.eth0.dns1"

    aput-object v5, v0, v8

    const-string v5, "net.eth0.dns2"

    aput-object v5, v0, v9

    const/4 v5, 0x2

    const-string v6, "net.eth0.dns3"

    aput-object v6, v0, v5

    const/4 v5, 0x3

    const-string v6, "net.eth0.dns4"

    aput-object v6, v0, v5

    const/4 v5, 0x4

    const-string v6, "net.gprs.dns1"

    aput-object v6, v0, v5

    const/4 v5, 0x5

    const-string v6, "net.gprs.dns2"
    ...
    .line 3800
    .local v1, apnstr:Ljava/lang/String;
    if-eqz v1, :cond_3
    ...
    .line 3806
    .local v2, dnsAddresses:[Ljava/lang/String;
    const-string v5, "ConnectivityService"

    const-string v6, "apn is cmwap"
    ...
    .line 3809
    .end local v2           #dnsAddresses:[Ljava/lang/String;
    :cond_3
    invoke-static {v0}, Lcom/android/server/ConnectivityService;->getNameServerList([Ljava/lang/String;)[Ljava/lang/String;
...
.method public getNameServers(Landroid/net/NetworkStateTracker;)[Ljava/lang/String;
    .locals 3
    .parameter "nt"
    ...
    const-string v2, "zhaoruiqing netType = "
    ...
    const-string v1, "zhaoruiqing return null "
    ...
    .line 3752
    :pswitch_0
    invoke-virtual {p0, p1}, Lcom/android/server/ConnectivityService;->getMobileNameServers(Landroid/net/NetworkStateTracker;)[Ljava/lang/String;
    ...
    .line 3754
    :pswitch_1
    invoke-virtual {p0, p1}, Lcom/android/server/ConnectivityService;->getWifiNameServers(Landroid/net/NetworkStateTracker;)[Ljava/lang/String;
...
.method public getWifiNameServers(Landroid/net/NetworkStateTracker;)[Ljava/lang/String;
    .locals 6
    .parameter "nt"
    ...
    sput-object v2, Lcom/android/server/ConnectivityService;->sDnsPropNames:[Ljava/lang/String;

    .line 3771
    sget-object v2, Lcom/android/server/ConnectivityService;->sDnsPropNames:[Ljava/lang/String;

    invoke-static {v2}, Lcom/android/server/ConnectivityService;->getNameServerList([Ljava/lang/String;)[Ljava/lang/String;
...
.method public removeDefaultRoute(Landroid/net/NetworkStateTracker;)V
    ...
    .line 2435
    const-string v3, "djt,removeDefaultRoute, linkProperties is null, returned"
    ...
    const-string v4, "djt,removeDefaultRoute for "
...
.method public requestRouteToHost(II)Z
    ...
    const-string v2, "requestRouteToHost: networkType "
    ...
    const-string v2, "requestRouteToHost: hostAddress "
...
.method public requestRouteToHostAddress(I[B)Z
    ...
    const-string v8, "requestRouteToHostAddress: networkType "
    ...
    const-string v8, "requestRouteToHostAddress: hostAddress "
...
.method public startUsingNetworkFeature(ILjava/lang/String;Landroid/os/IBinder;)I
    ...
    invoke-direct {v0, v14, v15}, Lcom/android/server/ConnectivityService;->handleDnsConfigurationChange(II)V
