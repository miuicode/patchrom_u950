...
.method protected notifyTetheredOfNewUpstreamIface(Ljava/lang/String;)V
    ...
    #getter for: Lcom/android/server/connectivity/Tethering;->mDefaultDnsServers:[Ljava/lang/String;
    invoke-static {v3}, Lcom/android/server/connectivity/Tethering;->access$3800(Lcom/android/server/connectivity/Tethering;)[Ljava/lang/String;
...
.method protected turnOffUpstreamMobileConnection()Z
    ...
    invoke-static {v0, v1}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$2902(Lcom/android/server/connectivity/Tethering$TetherMasterSM;I)I
...
.method protected turnOnMasterTetherSettings()Z
    ...
    #getter for: Lcom/android/server/connectivity/Tethering;->mZTEWifiCustom:Landroid/net/Wifi/ZTEWifiCustom;
    invoke-static {v4}, Lcom/android/server/connectivity/Tethering;->access$3400(Lcom/android/server/connectivity/Tethering;)Landroid/net/Wifi/ZTEWifiCustom;

    move-result-object v4

    invoke-virtual {v4}, Landroid/net/Wifi/ZTEWifiCustom;->isWifiApDhcpEnabled()Z
    ...
    invoke-static {v4}, Lcom/android/server/connectivity/Tethering;->access$3500(Lcom/android/server/connectivity/Tethering;)[Ljava/lang/String;
    ...
    #getter for: Lcom/android/server/connectivity/Tethering;->mZTEWifiCustom:Landroid/net/Wifi/ZTEWifiCustom;
    invoke-static {v6}, Lcom/android/server/connectivity/Tethering;->access$3400(Lcom/android/server/connectivity/Tethering;)Landroid/net/Wifi/ZTEWifiCustom;

    move-result-object v6

    invoke-virtual {v6}, Landroid/net/Wifi/ZTEWifiCustom;->getWifiApDhcpIpStart()Ljava/lang/String;
    ...
    invoke-virtual {v6}, Landroid/net/Wifi/ZTEWifiCustom;->getWifiApDhcpIpEnd()Ljava/lang/String;
    ...
    const-string v6, "New verion: mDhcpRange[2] ="
