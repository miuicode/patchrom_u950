...
# instance fields
.field public ALARM_ICON:I

.field public CHARGING_ICON:I
...
.field private mIsInitInstructionText:Z
...
.method public constructor <init>(Landroid/view/View;Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;Lcom/android/internal/widget/LockPatternUtils;Lcom/android/internal/policy/impl/KeyguardScreenCallback;Z)V
    ...
    iput v5, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->ALARM_ICON:I

    .line 70
    iput v7, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->CHARGING_ICON:I

    .line 102
    iput-boolean v8, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->mIsInitInstructionText:Z
    ...
    iput-wide v5, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->mNextTime:J
...
.method private getAltTextMessage(Llibcore/util/MutableInt;)Ljava/lang/CharSequence;
    ...
    .line 444
    :goto_0
    iget v1, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->CHARGING_ICON:I
...
.method private getPriorityTextMessage(Llibcore/util/MutableInt;)Ljava/lang/CharSequence;
    ...
    iget-boolean v1, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->mIsInitInstructionText:Z
...
.method private updateAlarmInfo()V
    ...
    invoke-virtual {v4}, Lcom/android/internal/widget/LockPatternUtils;->getNextAlarmTime()J

    move-result-wide v4

    iput-wide v4, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->mNextTime:J

    .line 381
    iget-wide v4, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->mNextTime:J
    ...
    iget v5, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->ALARM_ICON:I
    ...
    iget-wide v5, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->mNextTime:J
    ...
    invoke-direct {p0, v4, v0}, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->formatDayAndTime(Landroid/content/Context;Ljava/util/Calendar;)Ljava/lang/String;
...
.method private updateCarrierStateWithSimStatus(Lcom/android/internal/telephony/IccCard$State;)V
    ...
    const-string v5, "updateCarrierTextWithSimStatus(), simState = "
    ...
    invoke-static {v3, v4, v5}, Lcom/android/internal/util/CarrierUtils;->makeCarrierStringEx(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/CharSequence;

    move-result-object v1

    .line 567
    invoke-virtual {p0, v1}, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->verifyAirplaneMode(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    .line 585
    .local v2, mUMPlmn:Ljava/lang/CharSequence;
    iget-object v3, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->mUpdateMonitor:Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;

    invoke-virtual {v3}, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->getDefaultPlmnInit()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v3}, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->getDefaultPlmn()Ljava/lang/CharSequence;

    move-result-object v3

    iput-object v3, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->mPlmn:Ljava/lang/CharSequence;
    ...
    invoke-virtual {v3, v4}, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->SetTelephonyPlmn(Ljava/lang/CharSequence;)V
    ...
    .line 604
    .end local v2           #mUMPlmn:Ljava/lang/CharSequence;
    :pswitch_3
    invoke-direct {p0}, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->getContext()Landroid/content/Context;
...
.method resetStatusInfo()V
    ...
    .line 338
    iput-boolean v1, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->mIsInitInstructionText:Z
    ...
    .line 343
    invoke-virtual {p0, v1}, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->updateStatusLines(Z)V

    .line 344
    return-void
.end method

.method public setAlarmIcon(I)V
    .locals 0
    .parameter "drawableId"

    .prologue
    .line 809
    iput p1, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->ALARM_ICON:I
...
.method public setChargingIcon(I)V
    .locals 0
    .parameter "drawableId"

    .prologue
    .line 812
    iput p1, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->CHARGING_ICON:I
...
.method public setIsInitInstructionText()V
    .locals 1
    ...
    iput-boolean v0, p0, Lcom/android/internal/policy/impl/KeyguardStatusViewManager;->mIsInitInstructionText:Z
...
.method public verifyAirplaneMode(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    .locals 4
